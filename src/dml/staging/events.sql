...
SELECT
    ...
    TRY_TO_DATE(f.value:event_date::VARCHAR) AS event_date,
    TRY_TO_DATE(f.value:event_finish_date::VARCHAR) AS event_finish_date,
    TRY_TO_DATE(f.value:event_edit_date::VARCHAR) AS event_edit_date,
